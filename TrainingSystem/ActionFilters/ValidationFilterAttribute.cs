...
namespace TrainingSystem.ActionFilters
{
    public class ValidationFilterAttribute : IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext ActionExecutingContext)
        {
            ...
            //and here we check the object that the action take  as argument, where is the arg name contain dto or not?, this mean we not chechk the objcet sent by post man because basically all 
