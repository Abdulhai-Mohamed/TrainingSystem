    ...
    public partial class createDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ComapnyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyOfTheEmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CompanyOfTheEmployeeId,
                        principalTable: "Companies",
                        principalColumn: "ComapnyId");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Employees_CompanyOfTheEmployeeId",
                table: "Employees",
